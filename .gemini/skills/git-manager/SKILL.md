...
### 2. Selective Staging
- Use git add to stage files related to a single logical change.
...
- Execute the commit and confirm success.
...
- **Stage and Commit**: The primary task for wrapping up a feature or fix.
- **Review History**: Check git log to ensure consistent messaging style.
